...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: MyTripsPageWidget.routeName,
          path: MyTripsPageWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'myTripsPage')
              : MyTripsPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: MethodPageWidget.routeName,
          path: MethodPageWidget.routePath,
          builder: (context, params) => MethodPageWidget(),
        )
